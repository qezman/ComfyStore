  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.status === 200) {
        ...
        setResponseMessage("Error sending email: " + result.error);
      }
    } catch (error) {
  ...
  return (
    <section className="mt-6 mx-4">
      <aside className="text-center">
        <h1 className="text-2xl md:text-3xl font-medium">Get in touch with us</h1>
        <p className="mt-2 text-slate-600">
          Navigate through our thoughtfully crafted pricing tiers, tailored to meet the needs of any church.
        </p>
      </aside>
      ...
      <article className="mt-8 lg:grid lg:grid-cols-2 lg:w-[80%] lg:mx-auto lg:gap-x-4 xl:w-[75%] xl:gap-x-20">
        <aside className="">
          <article className="text-center md:text-left">
            ...
            <p className="text-sm pt-2 text-center text-slate-600 md:text-left">
              We value your input and inquiries, and our dedicated team at Sync Innovative is here to assist you.
            </p>
          </article>
          ...
          <form className="space-y-3 mt-4" onSubmit={handleSubmit}>
            ...
            <button className="bg-[#070b65cc] text-white px-6 py-1 rounded-lg" type="submit">
              Submit
            </button>
          </form>
          {responseMessage && (
        ...
        <aside className="mt-10 lg:mt-0">
          <h2 className="text-center text-2xl md:text-left">Or call us directly</h2>
          <p className="text-sm pt-2 text-center text-slate-600 md:text-left">
